#!/usr/bin/env bash
# GGUF Q4_K_M — deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct → DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M-GGUF
# 관찰 포인트: MoE Expert 가중치 양자화 시 붕괴 여부
...
OUTPUT_NAME="DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M-GGUF"
