#!/usr/bin/env bash
# GGUF Q3_K_M — Qwen/Qwen2.5-Coder-32B-Instruct → Qwen2.5-Coder-32B-Instruct-Q3_K_M-GGUF
# 관찰 포인트: 3비트에서도 문법 오류 없이 Perplexity 열화폭 측정 (약 14~15GB)
...
OUTPUT_NAME="Qwen2.5-Coder-32B-Instruct-Q3_K_M-GGUF"
