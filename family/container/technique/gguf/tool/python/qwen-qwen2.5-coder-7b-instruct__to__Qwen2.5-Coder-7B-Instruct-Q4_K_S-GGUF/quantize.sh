#!/usr/bin/env bash
# GGUF Q4_K_S — Qwen/Qwen2.5-Coder-7B-Instruct → Qwen2.5-Coder-7B-Instruct-Q4_K_S-GGUF
# 관찰 포인트: 파이프라인 디버깅·고속 이터레이션용 경량 베이스 (수 분 내 변환)
...
OUTPUT_NAME="Qwen2.5-Coder-7B-Instruct-Q4_K_S-GGUF"
