#!/usr/bin/env bash
# GGUF Q3_K_S — deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct → DeepSeek-Coder-V2-Lite-Instruct-Q3_K_S-GGUF
# 관찰 포인트: 3비트 극한 압축 시 Expert 라우팅 불균형·코드 인덴트 깨짐 여부
...
OUTPUT_NAME="DeepSeek-Coder-V2-Lite-Instruct-Q3_K_S-GGUF"
