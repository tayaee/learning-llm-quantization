#!/usr/bin/env bash
# AWQ INT4 — Qwen/Qwen2.5-Coder-32B-Instruct → Qwen2.5-Coder-32B-Instruct-AWQ-Int4-128g
# 관찰 포인트: 4비트에서 원본 성능 98%+ 유지 여부 (코딩 벤치 Baseline)
...
OUTPUT_NAME="Qwen2.5-Coder-32B-Instruct-AWQ-Int4-128g"
