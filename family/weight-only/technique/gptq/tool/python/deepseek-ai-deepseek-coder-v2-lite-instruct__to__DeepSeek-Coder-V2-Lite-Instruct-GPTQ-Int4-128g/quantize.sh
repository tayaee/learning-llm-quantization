#!/usr/bin/env bash
# GPTQ INT4 — deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct → DeepSeek-Coder-V2-Lite-Instruct-GPTQ-Int4-128g
# 관찰 포인트: MoE Expert 라우팅 게이트·FFN 양자화 시 캘리브 도메인 영향 (16B/Active 2.4B)
...
OUTPUT_NAME="DeepSeek-Coder-V2-Lite-Instruct-GPTQ-Int4-128g"
...
uv run "$TECH_DIR/src/gptq.py" \
  ...
  --bits 4 --group-size 128 --sym --desc-act \
