#!/usr/bin/env bash
# EXL2 3.5bpw — mistralai/Codestral-22B-v0.1 → Codestral-22B-v0.1-EXL2-3.5bpw
# 관찰 포인트: 3.5bpw에서 약 10~11GB로 축소, 긴 KV 캐시·대량 배치 여유 확인
...
OUTPUT_NAME="Codestral-22B-v0.1-EXL2-3.5bpw"
