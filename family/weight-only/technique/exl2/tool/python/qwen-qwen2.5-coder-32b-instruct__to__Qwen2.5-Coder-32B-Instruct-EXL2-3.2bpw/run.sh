#!/usr/bin/env bash
# EXL2 3.2bpw — Qwen/Qwen2.5-Coder-32B-Instruct → Qwen2.5-Coder-32B-Instruct-EXL2-3.2bpw
# 관찰 포인트: 3비트대 가변 비트레이트 품질 열화 비교
...
OUTPUT_NAME="Qwen2.5-Coder-32B-Instruct-EXL2-3.2bpw"
