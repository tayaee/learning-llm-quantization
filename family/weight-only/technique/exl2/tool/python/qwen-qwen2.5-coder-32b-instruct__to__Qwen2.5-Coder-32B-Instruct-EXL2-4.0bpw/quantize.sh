#!/usr/bin/env bash
# EXL2 4.0bpw — Qwen/Qwen2.5-Coder-32B-Instruct → Qwen2.5-Coder-32B-Instruct-EXL2-4.0bpw
# 관찰 포인트: 코딩 벤치마크 점수 유지율 Baseline (4비트 기준선)
...
OUTPUT_NAME="Qwen2.5-Coder-32B-Instruct-EXL2-4.0bpw"
