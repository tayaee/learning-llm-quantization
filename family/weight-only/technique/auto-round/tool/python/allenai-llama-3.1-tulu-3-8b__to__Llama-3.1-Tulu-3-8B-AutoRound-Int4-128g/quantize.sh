#!/usr/bin/env bash
# AutoRound INT4 — allenai/Llama-3.1-Tulu-3-8B → Llama-3.1-Tulu-3-8B-AutoRound-Int4-128g
...
OUTPUT_NAME="Llama-3.1-Tulu-3-8B-AutoRound-Int4-128g"
...
uv run "$TECH_DIR/src/auto-round.py" \
  --hf-model "$HF_MODEL" \
